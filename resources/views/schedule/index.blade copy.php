...
@section('content')
    ...
    // ชื่อผู้ใช้ที่ได้จากฐานข้อมูล

    var eventElement = document.createElement('div');
    eventElement.innerHTML = `<span style="cursor: pointer;">❌</span> ${eventTitle} (${eventStart})`;
    ...
    return {
        domNodes: [eventElement]
            ...
            eventDrop: function(info) {
                ...
                var newStartDateUTC = newStartDate.toISOString().slice(0, 19).replace('T', ' '); // รูปแบบ Y-m-d H:i:s
            ...
            eventResize: function(info) {
                var eventId = info.event.id;
                var userName = info.event.extendedProps.user_name;
